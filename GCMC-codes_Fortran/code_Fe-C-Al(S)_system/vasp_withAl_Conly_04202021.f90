...
!********************************************************************** 
      ...
      if ( Ccount > 1) then    
          read (97,*)qatom(1), qatom(2), qatom(3)   !! 1-Al, 2-Fe, 3-C
...
!********************************************************************** 
      ...
      if (natoms3 > 0) then
           open (76,file='tmpmagmom',access='append')
               write (76,'(a9,i4,a1,f4.2,i4,a1,f4.2,i4,a1,f4.2)') "MAGMOM = ", natoms1, "*", magS, natoms2, "*", magFe, natoms3, "*", magC 
           close (76)
      else
           open (76,file='tmpmagmom',access='append')
               write (76,'(a9,i4,a1,f4.2,i4,a1,f4.2)') "MAGMOM  = ", natoms1, "*", magS, natoms2, "*", magFe
           close (76)
      end if
